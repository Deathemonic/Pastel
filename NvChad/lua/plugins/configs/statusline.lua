...
options.diagnostic = {
   ...
   hint = {
      ...
      hl = { fg = options.colors.black_fg2 },
      icon = "  ",
   },
...
options.lsp_icon = {
   ...
   hl = { fg = options.colors.black_fg2, bg = options.colors.statusline_bg },
}

options.mode_colors = {
   ["n"] = { "NORMAL", options.colors.pink },
   ["no"] = { "N-PENDING", options.colors.pink },
   ["i"] = { "INSERT", options.colors.cyan },
   ["ic"] = { "INSERT", options.colors.cyan },
   ["t"] = { "TERMINAL", options.colors.green },
   ["v"] = { "VISUAL", options.colors.dark_purple },
   ["V"] = { "V-LINE", options.colors.dark_purple },
   [""] = { "V-BLOCK", options.colors.dark_purple },
   ...
   ["c"] = { "COMMAND", options.colors.red },
   ["cv"] = { "COMMAND", options.colors.red },
   ["ce"] = { "COMMAND", options.colors.red },
